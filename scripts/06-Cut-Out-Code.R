...
##### 02-02-2024 Looks like we don't need SingleR for this. ####################
##### ONly if we don't find cluster #20 markers (and others) ###################
...
ref_dir <- "/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/ref_data"
...
reffy <- CreateSeuratObject(raw_counts_mat) ### Just use the organoid5 Seurat Object
...
test_assay <- GetAssayData(organoid)
...
DimPlot(organoid, reduction = "harmony_res_0.5_umap", group.by = "Polioudakis_SingleR", label = TRUE, label.size = 6)
dev.off()
...
# idents updated 03-10-2024
newIdents <- c("GABAergic", "GABAergic", "Glutamatergic", "Astrocyte", "Astrocyte", "Glutamatergic", "Oligo/OPC", "GABAergic", "GABAergic", "Glutamatergic",
               "NPC - cycling", "NPC - cycling", "NPC", "NPC - cycling", "GPC", "Astrocyte", "Glutamatergic", 17, "NPC - cycling", "VLMC",
               "OPC", "NPC", "Oligo/OPC", "Serotonergic", 24)
organoid <- RenameIdents(organoid, '21' = "NPC - cycling")
...
out <- '/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/simpleafSeurat'
...
output_dir <- "/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/"
...
out <- '/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/'
...
# Output directory
out <- "/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/images/"  # Replace with your actual directory path
...
organoid1 <- readRDS('/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/organoid1.rds')
library(Seurat)
library(miQC)
...
organoid2 <- readRDS('/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/simpleafSeurat/organoid2.rds')
organoid2 <- T_QC
...
pdf(file = "/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/violin_plot.pdf", width = 15, height = 10)
...
plot2 <- LabelPoints(plot = plot1, points = top10, repel = TRUE)
pdf(file = "/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/variablefeatureplot_filtered_object.pdf", width = 15, height = 10)
plot1+plot2
dev.off()
...
pdf(file = "/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/pc1&pc2_filtered_object.pdf", width = 15, height = 20)
VizDimLoadings(T_QC, dims = 1:2, reduction = "pca")
dev.off()
pdf(file = "/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/pc1&pc2dimplot_filtered_object.pdf", width = 15, height = 20)
...
pdf(file = "/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/pc1_heatmap_filtered_object.pdf")
...
dev.off()
pdf(file = "/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/pcs1-15_heatmap_filtered_object.pdf")
DimHeatmap(T_QC.MiQC, dims = 1:15, cells = 500, balanced = TRUE)
#+ggplot2::scale_fill_gradientn(colors = c("steelblue1", "white", "tomato"))
dev.off()

#pca: elbow plot
pdf(file = "/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/pca_elbow_plot.pdf", width = 30, height = 30)
ElbowPlot(T_QC.MiQC)
dev.off()
...
pdf(file = "/projectnb/organoidlab/LabMember/akg/APOE_Jorganoid_project/outputs/umap_bycluster_filtered_object.pdf", width = 10, height = 10)
...
T_QC <- readRDS(file = "/projectnb/organoidlab/LabMember/dmurthy/projects/Single_Cell_RNA_Seq/organoid_SC_RNA_Seq_Data/Project_organoid_14311_B01_SCR_Lane.2020-07-20/compbio/Results_to_deliver/seurat_object.rds") 
...
pdf(file = "/projectnb/organoidlab/LabMember/dmurthy/projects/Single_Cell_RNA_Seq/organoid_SC_RNA_Seq_Analysis/Files/Redone_QC/QC_metrics_FP_before_cutoffs.pdf", width = 10, height = 5)
plot1 + plot2
dev.off()
...
pdf(file = "/projectnb/organoidlab/LabMember/dmurthy/projects/Single_Cell_RNA_Seq/organoid_SC_RNA_Seq_Analysis/Files/Redone_QC/QC_metrics_with_ribo_FP_before_cutoffs.pdf", width = 10, height = 5)
plot1 + plot2 + plot3
dev.off()
...
pdf(file = "/projectnb/organoidlab/LabMember/dmurthy/projects/Single_Cell_RNA_Seq/organoid_SC_RNA_Seq_Analysis/Files/Redone_QC/stringent_miQC_probability_plot.pdf", width = 15, height = 10)
PlotMiQC(T_QC, color.by = "miQC.probability") + ggplot2::scale_color_gradient(low = "grey", high = "purple")
dev.off()

pdf(file = "/projectnb/organoidlab/LabMember/dmurthy/projects/Single_Cell_RNA_Seq/organoid_SC_RNA_Seq_Analysis/Files/Redone_QC/stringent_miQC_keep_plot.pdf", width = 15, height = 10)
...
pdf(file = "/projectnb/organoidlab/LabMember/dmurthy/projects/Single_Cell_RNA_Seq/organoid_SC_RNA_Seq_Analysis/Files/Redone_QC/QC_mito_FP_after_mt_cutoff.pdf", width = 15, height = 10)
plot1 
dev.off()
...
plot1 <- FeatureScatter(T_QC, feature1 = "nCount_RNA", feature2 = "percent.mt") + labs(legend = "organoid_14311_run1") & NoLegend() 
plot2 <- FeatureScatter(T_QC, feature1 = "nCount_RNA", feature2 = "nFeature_RNA") +labs(legend = "organoid_14311_run1") & NoLegend() 
pdf(file = "/projectnb/organoidlab/LabMember/dmurthy/projects/Single_Cell_RNA_Seq/organoid_SC_RNA_Seq_Analysis/Files/Redone_QC/QC_metrics_FP_after_cutoffs.pdf", width = 10, height = 5)
plot1 + plot2 
dev.off()
...
plot2 <- FeatureScatter(T_QC, feature1 = "nCount_RNA", feature2 = "percent.ribo") +labs(legend = "organoid_14311_run1") & NoLegend() 
plot3 <- FeatureScatter(T_QC, feature1 = "nCount_RNA", feature2 = "nFeature_RNA") +labs(legend = "organoid_14311_run1") & NoLegend() 
pdf(file = "/projectnb/organoidlab/LabMember/dmurthy/projects/Single_Cell_RNA_Seq/organoid_SC_RNA_Seq_Analysis/Files/Redone_QC/QC_metrics_with_ribo_FP_after_cutoffs.pdf", width = 10, height = 5)
plot1 + plot2 + plot3
dev.off()
...
pdf("/projectnb/organoidlab/LabMember/dmurthy/projects/Single_Cell_RNA_Seq/organoid_SC_RNA_Seq_Analysis/Files/Redone_QC/QC_metric_VP_after_cutoffs.pdf", width = 10, height = 10)
p <- vp1 +  theme(axis.text.x = element_blank()) +vp2 + theme(axis.text.x = element_blank()) +vp3 + theme(axis.text.x = element_blank())
plot(p)
dev.off()
