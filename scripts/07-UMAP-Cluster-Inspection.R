...
# Assuming 'organoid' is your Seurat object and you want to remove cells with identity '24'
# First, find the cells with the identity '24'
cells_to_remove <- WhichCells(organoid, idents = "24")

# Now, create a new Seurat object without those cells
...
organoid <- RenameIdents(organoid, "Pigmented Epithelial" = "Pigmented \n Epithelial")
